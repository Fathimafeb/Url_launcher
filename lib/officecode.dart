...
class Bluebag extends StatefulWidget {
  const Bluebag({super.key});

  @override
  State<Bluebag> createState() => _BluebagState();
}

class _BluebagState extends State<Bluebag> {
  @override
    ...
    return Scaffold(
        ...
        body: Stack(
          children: [
                              ...
                              children: [
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                      ...
                                      borderRadius: BorderRadius.circular(20)),
                                  child: IconButton(onPressed: (){}, icon:const Icon(Icons.shopping_cart_checkout_outlined,color: Colors.blue,size:35,)),

                                ),
                                SizedBox(width:20,),
                                Container(
                                  height: 50,width: 260,decoration: BoxDecoration(borderRadius:BorderRadius.circular(15), color: Colors.blue[800],),
                                  child: Padding(
            ...
            Padding(
              padding: const EdgeInsets.only(left: 170,top:80),
